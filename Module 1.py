...
# Generating sample data for website analytics
website_data = {
...
# Generating sample data for social media engagement
social_media_data = {
    'Date': pd.date_range(start='2024-01-01', end='2024-04-30'),
...
# Generating sample data for sales transactions
sales_data = {
    'Date': pd.date_range(start='2024-01-01', end='2024-04-30'),
...
# No cleaning is performed in this example due to the simplicity of the generated data.
